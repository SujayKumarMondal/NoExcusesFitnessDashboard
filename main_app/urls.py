...
urlpatterns = [
    ...
    path("course/add", admin_views.add_work_out_plan, name='add_work_out_plan'),
    ...
    path("subject/add/", admin_views.add_work_out_plan_exercise, name='add_work_out_plan_exercise'),
    ...
    path("course/manage/", admin_views.manage_work_out_plan, name='manage_work_out_plan'),
    path("subject/manage/", admin_views.manage_work_out_plan_exercise, name='manage_work_out_plan_exercise'),
    ...
    path("course/delete/<int:id>",
         admin_views.delete_work_out_plan, name='delete_work_out_plan'),

    path("subject/delete/<int:subject_id>",
         admin_views.delete_work_out_plan_exercise, name='delete_work_out_plan_exercise'),
    ...
    path("course/edit/<int:id>",
         admin_views.edit_work_out_plan, name='edit_work_out_plan'),
    path("subject/edit/<int:subject_id>",
         admin_views.edit_work_out_plan_exercise, name='edit_work_out_plan_exercise'),
